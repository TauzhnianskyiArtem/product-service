...
import com.iprody.product.service.rest.validation.group.CreateActionGroup;
...
public class ProductController {
    ...
    @PostMapping
    public ProductResponseDto create(@Validated({Default.class, CreateActionGroup.class})
